import { Users, Categories, Destinations,Toures, Rates, Galleries,TourSchedules, Orders, TourSteps, UserSettings, Favorites} from "./models/index.js";
...
async function main(){
    ...
    await Favorites.sync({alter:true, logging:true});
